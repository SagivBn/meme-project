...
function printSticker(sticker, {y}) {
    gCtx.textAlign = sticker.align;
    gCtx.font = `${sticker.size}${gCtx.font.slice(2)} `;
    gCtx.fillStyle = sticker.color;
    gCtx.strokeText(sticker.txt, gLineStart[gCtx.textAlign], y);
    gCtx.fillText(sticker.txt, gLineStart[gCtx.textAlign], y);
}
...
function onToggleMenu() {
    ...
    const elGalleryContainer = document.querySelector('.image-gallery-container');
